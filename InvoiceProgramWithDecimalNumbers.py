# IS 280 Python InvoiceProgramWithDecimalNumbers Susan Novak

# !/usr/bin/env python3

# import Decimal and ROUND_HALF_UP from Decimal class
...
while choice == "y":
    ...
    # obtains user entry and converts it to decimal
